...
namespace Elements
{
    ...
    public partial class NYCDaylightEvaluationVantagePoint : GeometricElement
    {
        ...
        [JsonProperty("UnblockedDaylightCredit", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [JsonProperty("ProfileDaylightBlockage", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [JsonProperty("AvailableDaylight", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [JsonProperty("DaylightRemaining", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
